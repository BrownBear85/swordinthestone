...
public class SSSoundProvider extends SoundDefinitionsProvider {
    ...
    protected SSSoundProvider(DataGenerator dataGenerator, String modId, ExistingFileHelper helper, SSLanguageProvider languageProvider) {
        super(dataGenerator, modId, helper);
