...
public class SSItemModelProvider extends ItemModelProvider {
    ...
    public SSItemModelProvider(DataGenerator generator, String modid, ExistingFileHelper existingFileHelper, LanguageProvider languageProvider, AnimatedTextureProvider animatedTextureProvider, SSBlockStateProvider blockStateProvider) {
